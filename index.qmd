...
For this analysis we will use the jmpwashdata R Package @jmpwashdata. The package contains all data compiled by the [WHO/UNICEF Joint Monitoring Programme (JMP).](http://washdata.org)
...
@fig-sani-bas-u-income is a box- and jitterplot of countries with percentages of populations with access to basic sanitation in 2020 grouped by income classifications.

```{r}
#| label: fig-san-bas-u-income
#| fig-cap: Access to sanitation (urban) in 2020 by income classification.
#| fig-alt: |
#|   A boxplot with jittered points overlaid. The-axis represents income 
...
#| tbl-cap: urnab sanitation indicators for global regions,
